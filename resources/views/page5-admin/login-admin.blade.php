...
@section('tittle')
    <title>Millennium School : Schale</title>
@endsection
@section('form')
        ...
        <div class="center-wrap">
            <div class="section text-center">
                ...
                <div class="form-group">
                    <input type="text" name="username" class="form-control @error('username') is-invalid @enderror" placeholder="Masukkan username" id="nama" autocomplete="off">
